...
<div class="row">
  <div class="large-12 columns">
    <p>
      XAMPP は10年以上の実績があります &ndash; よってその背後には大きなコミュニティーが存在します。弊社の <a href="https://community.apachefriends.org">フォーラム</a> に参加、 %および <a href="https://www.facebook.com/we.are.xampp">Facebook</a> で「いいね」ボタンを押す、<a href="https://twitter.com/apachefriends">Twitter</a> でフォロー、このコミュニティーに参加することができます。
    </p>
  </div>
</div>
